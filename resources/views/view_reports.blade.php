...
<div class='navBar'>
    ...
    <div class='main'>
        ...
        <div class='header'>
            ...
            <h2>Welcome User</h2>
            <p>This is where you can find your missing items and if you find an item in this campus, report it to the security office located at Security Office</p>
        </div>

         <!-- content -->
        <div class='content'>
            <div class='card_report'>
                    <div class='title'><h1>Claim item</h1></div>
                    ...
                    <div class='form-container'>
                        ...
                        <form method='post' action=" {{ route('submit.claim')}} " enctype="multipart/form-data">
                            ...
                            <!-- 1st -->
                            <label for="item_1">Description</label>
                            <div class='items' name='item_1'>
                                <!-- 1st 1 -->
                                <div class='panel'>

                                <div class='inner-panel'>
                                        <input id='item_id' name='item_id' type="text" placeholder=' '></input>
                                        <label for="item_id">Item id</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='storage_location' name='storage_location' type="text" placeholder=' '></input>
                                ...
                                <!-- 1st 2 -->
                                <div class='panel'>
                                    <div class='inner-panel date-panel'>
                                        <input id='date_retrieved' name='date_retrieved' type="date" placeholder=' '></input>
                                        <label for="date_retrieved">Date retrieved</label>
                                    </div>
                                </div>
                            ...
                            <!-- 2nd -->
                             <label for="item_2">Retriever's description</label>
                             <div class='items' name='item_2'>
                                <!-- 2nd 1 -->
                                <div class='panel'>
                                    <div class='inner-panel'>
                                        <input id='first_name' name='first_name' type="text" placeholder=' '></input>
                                        <label for="first_name">First name</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='middle_name' name='middle_name' type="text" placeholder=' '></input>
                                        <label for="middle_name">Middle name</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='last_name' name='last_name' type="text" placeholder=" "></input>
                                ...
                                <div class='panel'>
                                    <div class='inner-panel'>
                                        <input id='email' name='email' type="text" placeholder=" "></input>
                                        <label for="email">Email</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='contact_no' name='contact_no' type="text" placeholder=' '></input>
                                        <label for="contact_no">Contact no</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='person_id' name='person_id' type="text" placeholder=' '></input>
                                ...
                                <div class='panel'>
                                    <div class='inner-panel'>
                                        <input style='border-radius: 0;' id='person_id' name='proof_i' type="file" placeholder=' '></input>
                                        <label for="person_id">Proof of ownership</label>
                                    </div>

                                    <div class='inner-panel'>
                                        <input id='proof' name='proof_t' type="text" placeholder=' '></input>
                                        <label for="proof">Proof of ownership (Description)</label>
                                    </div>
                                </div>
